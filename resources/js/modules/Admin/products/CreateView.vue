...
<template>
    <AppToolbar title="Users List" :breadcrumbs="[
        { name: 'Products', link: 'Dashboard' },
        { name: 'Create Product', link: 'ProductsCreate' },
    ]" />
    <!-- Container -->
        ...
        <div class="flex grow gap-5 lg:gap-7.5">
            <div class="hidden lg:block w-[230px] shrink-0">
                <div class="w-[230px]" data-kt-sticky="true" data-kt-sticky-animation="true"
                    data-kt-sticky-class="fixed z-4 left-auto top-[3rem]" data-kt-sticky-name="scrollspy"
                            ...
                            <div class="flex items-center justify-between flex-wrap grow gap-2.5">
                                ...
                                <div class="kt-image-input size-16" data-kt-image-input="true">
                                    ...
                                    <div class="kt-image-input-placeholder border-2 border-green-500 kt-image-input-empty:border-input"
                                        ...
                                        style="background-image:url(/storage/assets/media/avatars/blank.png)">
                    ...
                    <div class="kt-card-content">
                        <div class="grid gap-5 mb-7">
                            ...
                            <div
                                ...
                                <div class="flex items-center flex-wrap gap-3.5">
                                    <img alt="" class="size-6 shrink-0"
                                        src="/storage/assets/media/brand-logos/linkedin.svg" />
                                    <div class="flex flex-col gap-0.5">
                                        <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                                            Linkedin
                                        </a>
                        ...
                        <div class="flex items-center flex-wrap gap-2.5 mb-7.5">
                            ...
                            <a class="kt-btn kt-btn-outline" href="#">
                                <img alt="" class="size-5" src="/storage/assets/media/brand-logos/microsoft-5.svg" />
                                Sign in with Microsoft
                            </a>
                            <a class="kt-btn kt-btn-outline" href="#">
                                <img alt="" class="size-5" src="/storage/assets/media/brand-logos/facebook.svg" />
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-7.5">
                                <label
                                    ...
                                    <div class="flex flex-col place-items-center place-content-center rounded-xl grow">
                                        <div class="flex items-center h-11">
                                            <img alt="" class="w-5" src="/storage/assets/media/brand-logos/azure.svg" />
                                        </div>
                                ...
                                <label
                                    ...
                                    <div class="flex flex-col place-items-center place-content-center rounded-xl grow">
                                        <div class="flex items-center h-11">
                                            <img alt="" class="w-24"
                                                src="/storage/assets/media/brand-logos/openid.svg" />
                                        </div>
                                        <span class="text-base font-medium text-mono">
                                            OpenID Connect
                                        </span>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-7.5">
                            <div>
                                <label
                                    ...
                                    style="background-image: url('/storage/assets/media/images/600x400/28.jpg')">
                            ...
                            <div>
                                <label
                                    class="flex items-end border bg-no-repeat bg-cover border-input rounded-xl has-checked:border-green-500 has-checked:border-3 has-checked:[&_.checked]:flex h-[170px] mb-0.5"
                                    style="background-image: url('/storage/assets/media/images/600x400/32.jpg')">
                            ...
                            <div>
                                <label
                                    class="flex items-end border bg-no-repeat bg-cover border-input rounded-xl has-checked:border-green-500 has-checked:border-3 has-checked:[&_.checked]:flex h-[170px] mb-0.5"
                                    style="background-image: url('/storage/assets/media/images/600x400/30.jpg')">
                                    <input class="appearance-none" name="appearance_option" type="radio" value="2" />
                                    <span class="checked hidden">
                                        <i
                                            class="ki-solid ki-check-circle ml-5 mb-5 text-xl text-green-500 leading-none">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z"
                                        ...
                                        <div
                                            class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                                            <img alt="" class="h-5" src="/storage/assets/media/brand-logos/slack.svg" />
                                        </div>
                                    </div>
                                    <div class="flex flex-col">
                                        <a class="text-sm font-medium text-mono hover:text-primary mb-px" href="#">
                    ...
                    <div class="kt-card-content grid gap-5 lg:gap-7.5 lg:py-7.5 py-5">
                        <div class="grid gap-5">
                            ...
                            <div
                                ...
                                <div class="flex items-center flex-wrap gap-3.5">
                                    <img alt="" class="size-8 shrink-0"
                                        src="/storage/assets/media/brand-logos/equacoin.svg" />
                                    <div class="flex flex-col">
                                        <div class="flex items-center gap-1.5">
                                            <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                                                Equacoin
                            ...
                            <div
                                ...
                                <div class="flex items-center flex-wrap gap-3.5">
                                    <img alt="" class="size-8 shrink-0"
                                        src="/storage/assets/media/brand-logos/evernote.svg" />
                                    <div class="flex flex-col">
                                        <div class="flex items-center gap-1.5">
                                            <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                                                Evernote
                            ...
                            <div
                                ...
                                <div class="flex items-center flex-wrap gap-3.5">
                                    <img alt="" class="size-8 shrink-0"
                                        src="/storage/assets/media/brand-logos/inferno.svg" />
                                    <div class="flex flex-col">
                                        <div class="flex items-center gap-1.5">
                                            <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                                                Inferno
                            ...
                            <div
                                ...
                                <div class="flex items-center flex-wrap gap-3.5">
                                    <img alt="" class="size-8 shrink-0"
                                        src="/storage/assets/media/brand-logos/jira.svg" />
                                    <div class="flex flex-col">
                                        <div class="flex items-center gap-1.5">
                                            <a class="text-sm font-medium text-mono hover:text-primary" href="#">
                                                Jira
...
<style scoped>
.singl-sign-on-bg {
    background-image: url('/storage/assets/media/images/2600x1600/bg-2.png');
}

.dark .singl-sign-on-bg {
    background-image: url('/storage/assets/media/images/2600x1600/bg-2-dark.png');
}

.user-access-bg {
    background-image: url('/storage/assets/media/images/2600x1200/bg-5.png');
}

.dark .user-access-bg {
    background-image: url('/storage/assets/media/images/2600x1200/bg-5-dark.png');
}

.sso-active:has(:checked) {
    background-image: url('/storage/assets/media/images/2600x1600/bg-1.png');
}

.dark .sso-active:has(:checked) {
    background-image: url('/storage/assets/media/images/2600x1600/bg-1-dark.png');
}
</style>
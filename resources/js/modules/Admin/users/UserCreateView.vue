         ...
         <div class="kt-card pb-2.5">
          ...
          <div class="kt-card-content grid gap-5">
           ...
           <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
            ...
            <input class="kt-input" type="text" placeholder="Type your name here" value=""/>
           </div>
           <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
            <label class="kt-form-label max-w-56">
             Phone number
           ...
           <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
            ...
            <input class="kt-input" type="text" value="" placeholder="aaa@pos.com"/>
           </div>
           <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
            <label class="kt-form-label max-w-56">
             Address
            </label>
            <input class="kt-input" placeholder="Type your address here" type="text" value=""/>
           </div>
           <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
            <label class="kt-form-label max-w-56">
             Country
           ...
           <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
            ...
            <input class="kt-input" type="text" value="" placeholder="Type your city"/>
           </div>
           <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
            <label class="kt-form-label max-w-56">
             Postcode
            </label>
            <input class="kt-input" type="text" value="" placeholder="Post code"/>
           </div>

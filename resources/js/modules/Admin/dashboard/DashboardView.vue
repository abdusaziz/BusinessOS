<template>
    <AppToolbar title="Users List" :breadcrumbs="[{ name: 'Home', link: 'Dashboard' },]" />   
    <!-- Container -->
                                            ...
                                            <div class="kt-card-content flex flex-col place-content-center gap-5">
                                                <div class="flex justify-center">
                                                    <img alt="image" class="dark:hidden max-h-[180px]"
                                                        src="/storage/assets/media/illustrations/32.svg" />
                                                    <img alt="image" class="light:hidden max-h-[180px]"
                                                        src="/storage/assets/media/illustrations/32-dark.svg" />
                                                </div>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="flex -space-x-2">
                                                                                <div class="flex">
                                                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                                        src="/storage/assets/media/avatars/300-24.png" />
                                                                                </div>
                                                                                <div class="flex">
                                                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                                        src="/storage/assets/media/avatars/300-7.png" />
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                ...
                                                <div class="flex flex-col gap-5">
                                                        ...
                                                        <div class="flex items-center gap-2.5">
                                                            <div class="">
                                                                <img class="h-9 rounded-full"
                                                                    src="/storage/assets/media/avatars/gray/1.png" />
                                                            </div>
                                                            <div class="flex flex-col gap-0.5">
                                                    ...
                                                    <div class="flex items-center justify-between gap-2.5">
                                                        <div class="flex items-center gap-2.5">
                                                            <div class="">
                                                                <img class="h-9 rounded-full"
                                                                    src="/storage/assets/media/avatars/gray/2.png" />
                                                            </div>
                                                            <div class="flex flex-col gap-0.5">
                                                                <a class="flex items-center gap-1.5 leading-none font-medium text-sm text-mono hover:text-primary"
                                                                    href="html/demo8/public-profile/teams.html">
                                                    ...
                                                    <div class="flex items-center justify-between gap-2.5">
                                                        <div class="flex items-center gap-2.5">
                                                            <div class="">
                                                                <img class="h-9 rounded-full"
                                                                    src="/storage/assets/media/avatars/gray/3.png" />
                                                            </div>
                                                            <div class="flex flex-col gap-0.5">
                                                                <a class="flex items-center gap-1.5 leading-none font-medium text-sm text-mono hover:text-primary"
                                                                    href="html/demo8/public-profile/teams.html">

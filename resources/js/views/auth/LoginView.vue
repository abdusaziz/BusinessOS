    ...
    <form action="#" class="kt-card-content flex flex-col gap-5 p-10" id="sign_in_form" method="get">
     ...
     <div class="grid grid-cols-2 gap-2.5">
      <a class="kt-btn kt-btn-outline justify-center" href="#">
       <img alt="" class="size-3.5 shrink-0" src="../../metronic/assets/media/brand-logos/google.svg"/>
       Use Google
      </a>
      <a class="kt-btn kt-btn-outline justify-center" href="#">
       <img alt="" class="size-3.5 shrink-0 dark:hidden" src="../../metronic/assets/media/brand-logos/apple-black.svg"/>
       <img alt="" class="size-3.5 shrink-0 light:hidden" src="../../metronic/assets/media/brand-logos/apple-white.svg"/>
       Use Apple
      </a>
     </div>
     ...
     <div class="flex flex-col gap-1">
      <div class="flex items-center justify-between gap-1">
       ...
       <a class="text-sm kt-link shrink-0" href="html/demo8/authentication/classic/reset-password/enter-email.html">
        Forgot Password?
       </a>
      </div>

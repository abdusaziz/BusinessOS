...
<template>
    <div class="flex grow" style="--sidebar-width: 90px">
        <!-- Header -->
        <header class="flex lg:hidden items-center fixed z-10 top-0 start-0 end-0 shrink-0 bg-muted h-(--header-height)"
            ...
            <div class="kt-container-fixed flex items-center justify-between flex-wrap gap-3">
                <a href="html/demo8.html">
                    <img class="dark:hidden min-h-[30px]" src="@/theme/assets/media/app/mini-logo-gray.svg" />
                    <img class="hidden dark:block min-h-[30px]" src="@/theme/assets/media/app/mini-logo-gray-dark.svg" />
                </a>
        ...
        <div class="flex flex-col lg:flex-row grow pt-(--header-height) lg:pt-0">
            ...
            <div class="fixed top-0 bottom-0 z-20 hidden lg:flex flex-col items-stretch shrink-0 bg-muted [--kt-drawer-enable:true] lg:[--kt-drawer-enable:false]"
                ...
                <div class="hidden lg:flex items-center justify-center shrink-0 pt-8 pb-3.5" id="sidebar_header">
                    <a href="html/demo8.html">
                        <img class="dark:hidden min-h-[42px]" src="@/theme/assets/media/app/mini-logo-square-gray.svg" />
                        <img class="hidden dark:block min-h-[42px]"
                            src="@/theme/assets/media/app/mini-logo-square-gray-dark.svg" />
                    </a>
                </div>
                    ...
                    <div class="kt-menu flex flex-col gap-2.5 grow" data-kt-menu="true" id="sidebar_menu">
                        ...
                        <div class="kt-menu-item" data-kt-menu-item-offset="-10px, 14px"
                            ...
                            <div
                                ...
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link" href="html/demo8/public-profile/network.html">
                                        <span class="kt-menu-title">
                                            Network
                                        </span>
                                    </a>
                                ...
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link" href="html/demo8/public-profile/activity.html">
                                        <span class="kt-menu-title">
                                            Activity
                                        </span>
                                    </a>
                                ...
                                <div class="kt-menu-item" data-kt-menu-item-placement="right-start"
                                    ...
                                    <div class="kt-menu-default kt-menu-dropdown gap-0.5 w-[220px]">
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="html/demo8/public-profile/empty.html">
                                                <span class="kt-menu-title">
                                                    Empty
                                                </span>
                                            </a>
                        ...
                        <div class="kt-menu-item" data-kt-menu-item-offset="-10px, 14px"
                            ...
                            <div
                                ...
                                <div class="kt-menu-item" data-kt-menu-item-placement="right-start"
                                    ...
                                    <div class="kt-menu-default kt-menu-dropdown gap-0.5 w-[220px]">
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="html/demo8/account/home/get-started.html">
                                                <span class="kt-menu-title">
                                                    Get Started
                                                </span>
                                            </a>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="html/demo8/account/home/user-profile.html">
                                                <span class="kt-menu-title">
                                                    User Profile
                                                </span>
                                            </a>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="html/demo8/account/home/company-profile.html">
                                                <span class="kt-menu-title">
                                                    Company Profile
                                                </span>
                                            </a>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="html/demo8/account/home/settings-modal.html">
                                                <span class="kt-menu-title">
                                                    Settings - Modal
                                                </span>
                                            </a>
                                ...
                                <div class="kt-menu-item" data-kt-menu-item-placement="right-start"
                                    ...
                                    <div class="kt-menu-default kt-menu-dropdown gap-0.5 w-[220px]">
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="html/demo8/account/billing/basic.html">
                                                <span class="kt-menu-title">
                                                    Billing - Basic
                                                </span>
                                            </a>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="html/demo8/account/billing/enterprise.html">
                                                <span class="kt-menu-title">
                                                    Billing - Enterprise
                                                </span>
                                            </a>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="html/demo8/account/billing/plans.html">
                                                <span class="kt-menu-title">
                                                    Plans
                                                </span>
                                            </a>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="html/demo8/account/billing/history.html">
                                                <span class="kt-menu-title">
                                                    Billing History
                                                </span>
                                            </a>
                                ...
                                <div class="kt-menu-item" data-kt-menu-item-placement="right-start"
                                    ...
                                    <div class="kt-menu-default kt-menu-dropdown gap-0.5 w-[220px]">
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="html/demo8/account/security/get-started.html">
                                                <span class="kt-menu-title">
                                                    Get Started
                                                </span>
                                            </a>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="html/demo8/account/security/overview.html">
                                                <span class="kt-menu-title">
                                                    Security Overview
                                                </span>
                                            </a>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="html/demo8/account/security/security-log.html">
                                                <span class="kt-menu-title">
                                                    Security Log
                                                </span>
                                            </a>
                                ...
                                <div class="kt-menu-item" data-kt-menu-item-placement="right-start"
                                    ...
                                    <div class="kt-menu-default kt-menu-dropdown gap-0.5 w-[220px]">
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="html/demo8/account/members/team-starter.html">
                                                <span class="kt-menu-title">
                                                    Teams Starter
                                                </span>
                                            </a>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="html/demo8/account/members/team-info.html">
                                                <span class="kt-menu-title">
                                                    Team Info
                                                </span>
                                            </a>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link"
                                                href="html/demo8/account/members/members-starter.html">
                                                <span class="kt-menu-title">
                                                    Members Starter
                                                </span>
                                            </a>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="html/demo8/account/members/team-members.html">
                                                <span class="kt-menu-title">
                                                    Team Members
                                                </span>
                                            </a>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="html/demo8/account/members/roles.html">
                                                <span class="kt-menu-title">
                                                    Roles
                                                </span>
                                            </a>
                                ...
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link" href="html/demo8/account/integrations.html">
                                        <span class="kt-menu-title">
                                            Integrations
                                        </span>
                                    </a>
                                ...
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link" href="html/demo8/account/notifications.html">
                                        <span class="kt-menu-title">
                                            Notifications
                                        </span>
                                    </a>
                                ...
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link" href="html/demo8/account/api-keys.html">
                                        <span class="kt-menu-title">
                                            API Keys
                                        </span>
                                    </a>
                                ...
                                <div class="kt-menu-item" data-kt-menu-item-placement="right-start"
                                    ...
                                    <div class="kt-menu-default kt-menu-dropdown gap-0.5 w-[220px]">
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="html/demo8/account/appearance.html">
                                                <span class="kt-menu-title">
                                                    Appearance
                                                </span>
                                            </a>
                                        ...
                                        <div class="kt-menu-item">
                                            <a class="kt-menu-link" href="html/demo8/account/invite-a-friend.html">
                                                <span class="kt-menu-title">
                                                    Invite a Friend
                                                </span>
                                            </a>
                ...
                <div class="flex flex-col gap-5 items-center shrink-0 pb-4" id="sidebar_footer">
                    <div class="flex flex-col gap-1.5">
                        <!-- Chat -->
                        <button
                            class="kt-btn kt-btn-ghost kt-btn-icon size-9 hover:bg-background hover:[&_i]:text-primary"
                        ...
                        <div class="hidden kt-drawer kt-drawer-end card flex-col max-w-[90%] w-[450px] top-5 bottom-5 end-5 rounded-xl border border-border"
                                    ...
                                    <div class="flex items-center justify-between flex-wrap gap-2 px-5">
                                        <div class="flex items-center flex-wrap gap-2">
                                            <div
                                                ...
                                                <img alt="" class="size-7" src="@/theme/assets/media/brand-logos/gitlab.svg">
                                                </img>
                                            </div>
                                            ...
                                            <div class="flex -space-x-2">
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                        src="@/theme/assets/media/avatars/300-4.png" />
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                        src="@/theme/assets/media/avatars/300-1.png" />
                                                </div>
                                                <div class="flex">
                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                        src="@/theme/assets/media/avatars/300-2.png" />
                                                </div>
                                                <div class="flex">
                                                    <span
                            ...
                            <div class="kt-scrollable-y-auto grow" data-kt-scrollable="true"
                                ...
                                <div class="flex flex-col gap-5 py-5">
                                    <div class="flex items-end gap-3.5 px-5">
                                        <img alt="" class="rounded-full size-9" src="@/theme/assets/media/avatars/300-5.png" />
                                        <div class="flex flex-col gap-1.5">
                                            <div
                                        ...
                                        <div class="relative shrink-0">
                                            <div class="kt-avatar size-9">
                                                <div class="kt-avatar-image">
                                                    <img alt="avatar" src="@/theme/assets/media/avatars/300-2.png">
                                                    </img>
                                                </div>
                                    ...
                                    <div class="flex items-end gap-3.5 px-5">
                                        <img alt="" class="rounded-full size-9" src="@/theme/assets/media/avatars/300-4.png" />
                                        <div class="flex flex-col gap-1.5">
                                            <div
                                                class="kt-card shadow-none flex flex-col bg-accent/60 gap-2.5 p-3 rounded-bs-none text-2sm">
                                    ...
                                    <div class="flex items-end gap-3.5 px-5">
                                        <img alt="" class="rounded-full size-9" src="@/theme/assets/media/avatars/300-1.png" />
                                        <div class="flex flex-col gap-1.5">
                                            <div
                                                class="kt-card shadow-none flex flex-col bg-accent/60 gap-2.5 p-3 rounded-bs-none text-2sm">
                            ...
                            <div class="mb-2.5">
                                <div class="flex grow gap-2 px-5 py-3.5 bg-accent/60 mb-2.5 border-y border-border"
                                    ...
                                    <div class="kt-avatar size-9">
                                        <div class="kt-avatar-image">
                                            <img alt="avatar" src="@/theme/assets/media/avatars/300-14.png">
                                            </img>
                                        </div>
                                        <div class="kt-avatar-indicator -end-2 -bottom-2">
                                            <div class="kt-avatar-status kt-avatar-status-online size-2.5">
                                ...
                                <div class="flex flex-col kt-scrollable-y-auto max-h-[400px] divide-y divide-border">
                                    <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
                                        <div class="flex items-center flex-wrap gap-2">
                                            <div
                                                ...
                                                <img alt="" class="size-6" src="@/theme/assets/media/brand-logos/jira.svg">
                                                </img>
                                            </div>
                                            <div class="flex flex-col">
                                                <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
                                    ...
                                    <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
                                        <div class="flex items-center flex-wrap gap-2">
                                            <div
                                                class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
                                                <img alt="" class="size-6" src="@/theme/assets/media/brand-logos/inferno.svg">
                                                </img>
                                            </div>
                                            <div class="flex flex-col">
                                                <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
                                    ...
                                    <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
                                        <div class="flex items-center flex-wrap gap-2">
                                            <div
                                                class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
                                                <img alt="" class="size-6" src="@/theme/assets/media/brand-logos/evernote.svg">
                                                </img>
                                            </div>
                                            <div class="flex flex-col">
                                                <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
                                    ...
                                    <div class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5">
                                        <div class="flex items-center flex-wrap gap-2">
                                            <div
                                                class="flex items-center justify-center shrink-0 rounded-full bg-accent/60 border border-border size-10">
                                                <img alt="" class="size-6" src="@/theme/assets/media/brand-logos/gitlab.svg" />
                                            </div>
                                            <div class="flex flex-col">
                                                <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
                                                    Gitlab
                                        ...
                                        <div class="flex items-center flex-wrap gap-2">
                                            <div
                                                ...
                                                <img alt="" class="size-6"
                                                    src="@/theme/assets/media/brand-logos/google-webdev.svg" />
                                            </div>
                                            <div class="flex flex-col">
                                                <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
                                                    Google webdev
                    ...
                    <div data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px"
                        ...
                        <div class="cursor-pointer shrink-0" data-kt-dropdown-toggle="true">
                            <img alt="" class="size-9 rounded-lg shrink-0" src="@/theme/assets/media/avatars/300-2.png" />
                        </div>
                                ...
                                <li data-kt-dropdown="true" data-kt-dropdown-placement="right-start"
                                    ...
                                    <div class="kt-dropdown-menu w-[220px]" data-kt-dropdown-menu="true">
                                        <ul class="kt-dropdown-menu-sub">
                                            ...
                                            <li>
                                                <a class="kt-dropdown-menu-link"
                                                    href="html/demo8/account/home/user-profile.html">
                                            ...
                                            <li>
                                                <a class="kt-dropdown-menu-link"
                                                    href="html/demo8/account/security/overview.html">
                                    ...
                                    <button class="kt-dropdown-menu-toggle py-1" data-kt-dropdown-toggle="true">
                                        ...
                                        <span class="ms-auto kt-badge kt-badge-stroke shrink-0">
                                            ...
                                            <img alt="" class="inline-block size-3.5 rounded-full"
                                                src="@/theme/assets/media/flags/united-states.svg" />
                                        </span>
                                    </button>
                                        ...
                                        <ul class="kt-dropdown-menu-sub">
                                            ...
                                            <li class="">
                                                <a class="kt-dropdown-menu-link" href="?dir=rtl">
                                                    <span class="flex items-center gap-2">
                                                        <img alt="" class="inline-block size-4 rounded-full"
                                                            src="@/theme/assets/media/flags/saudi-arabia.svg" />
                                                        <span class="kt-menu-title">
                                                            Arabic(Saudi)
                                                        </span>
                                                    </span>
                                            ...
                                            <li class="">
                                                <a class="kt-dropdown-menu-link" href="?dir=ltr">
                                                    <span class="flex items-center gap-2">
                                                        <img alt="" class="inline-block size-4 rounded-full"
                                                            src="@/theme/assets/media/flags/spain.svg" />
                                                        <span class="kt-menu-title">
                                                            Spanish
                                                        </span>
                                                    </span>
                                            ...
                                            <li class="">
                                                <a class="kt-dropdown-menu-link" href="?dir=ltr">
                                                    <span class="flex items-center gap-2">
                                                        <img alt="" class="inline-block size-4 rounded-full"
                                                            src="@/theme/assets/media/flags/germany.svg" />
                                                        <span class="kt-menu-title">
                                                            German
                                                        </span>
                                                    </span>
                                            ...
                                            <li class="">
                                                <a class="kt-dropdown-menu-link" href="?dir=ltr">
                                                    <span class="flex items-center gap-2">
                                                        <img alt="" class="inline-block size-4 rounded-full"
                                                            src="@/theme/assets/media/flags/japan.svg" />
                                                        <span class="kt-menu-title">
                                                            Japanese
                                                        </span>
                                                    </span>
                        ...
                        <div class="pb-5">
                            ...
                            <div class="kt-container-fixed flex items-center justify-between flex-wrap gap-3">
                                ...
                                <div class="flex items-center flex-wrap gap-1.5 lg:gap-2.5">
                                    <!-- Search -->
                                    <button
                                        class="group kt-btn kt-btn-ghost kt-btn-icon size-9 hover:bg-primary/10 hover:[&_i]:text-primary"
                                    ...
                                    <!-- Notifications -->
                                    <button
                                        class="kt-btn kt-btn-ghost kt-btn-icon size-9 hover:bg-primary/10 hover:[&_i]:text-primary"
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex grow gap-2.5 px-5">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar" src="@/theme/assets/media/avatars/300-4.png">
                                                                </img>
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                    ...
                                                    <div class="flex grow gap-2.5 px-5">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar" src="@/theme/assets/media/avatars/300-5.png">
                                                                </img>
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                    ...
                                                    <div class="flex grow gap-2.5 px-5" id="notification_request_3">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar" src="@/theme/assets/media/avatars/300-27.png">
                                                                </img>
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                    ...
                                                    <div class="flex grow gap-2.5 px-5">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar" src="@/theme/assets/media/avatars/300-10.png">
                                                                </img>
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                        ...
                                                        <div class="flex flex-col gap-3.5 grow">
                                                            ...
                                                            <div
                                                                ...
                                                                <img class="h-5"
                                                                    src="@/theme/assets/media/file-types/pdf.svg" />
                                                    ...
                                                    <div class="flex grow gap-2.5 px-5">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar" src="@/theme/assets/media/avatars/300-11.png">
                                                                </img>
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                        ...
                                                        <div class="flex flex-col gap-3.5 grow">
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <img class="h-5"
                                                                        src="@/theme/assets/media/file-types/figma.svg" />
                                                                </div>
                                                                <a class="hover:text-primary font-medium text-secondary-foreground text-xs me-1"
                                                                    href="#">
                                                                    Launcher-UIkit.fig
                                            ...
                                            <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true"
                                                ...
                                                <div class="flex flex-col gap-5 pt-3 pb-4">
                                                    <div class="flex grow gap-2.5 px-5" id="notification_request_13">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar" src="@/theme/assets/media/avatars/300-25.png">
                                                                </img>
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                    ...
                                                    <div class="flex grow gap-2.5 px-5">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar"
                                                                    src="@/theme/assets/media/avatars/300-34.png" />
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                                    class="kt-avatar-status kt-avatar-status-online size-2.5">
                                                        ...
                                                        <div class="flex flex-col gap-3.5 grow">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="flex items-center gap-1.5">
                                                                    <img class="h-6"
                                                                        src="@/theme/assets/media/file-types/xls.svg" />
                                                    ...
                                                    <div class="flex grow gap-2 px-5">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar" src="@/theme/assets/media/avatars/300-29.png">
                                                                </img>
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                                    ...
                                                                    <div class="flex -space-x-2">
                                                                        <div class="flex">
                                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                                                src="@/theme/assets/media/avatars/300-3.png" />
                                                                        </div>
                                                                        <div class="flex">
                                                                            <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                                                src="@/theme/assets/media/avatars/300-2.png" />
                                                    ...
                                                    <div class="flex grow gap-2.5 px-5" id="notification_request_3">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar" src="@/theme/assets/media/avatars/300-30.png">
                                                                </img>
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                    ...
                                                    <div class="flex grow gap-2.5 px-5">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar" src="@/theme/assets/media/avatars/300-24.png">
                                                                </img>
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                ...
                                                <div class="flex flex-col gap-5 pt-3 pb-4">
                                                    <div class="flex grow gap-2 px-5">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar"
                                                                    src="@/theme/assets/media/avatars/300-15.png" />
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                                    class="kt-avatar-status kt-avatar-status-online size-2.5">
                                                        ...
                                                        <div class="flex flex-col gap-3 grow"
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="flex items-center gap-2.5">
                                                                        <div
                                                                            class="border border-primary/10 rounded-lg">
                                                                            <div
                                                    ...
                                                    <div class="flex grow gap-2.5 px-5">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar" src="@/theme/assets/media/avatars/300-6.png">
                                                                </img>
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                    ...
                                                    <div class="flex grow gap-2.5 px-5">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar" src="@/theme/assets/media/avatars/300-12.png">
                                                                </img>
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                        ...
                                                        <div class="flex flex-col gap-3.5 grow">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="flex items-center gap-1.5">
                                                                    <img class="h-6"
                                                                        src="@/theme/assets/media/file-types/word.svg" />
                                                                    <div class="flex flex-col gap-0.5">
                                                                        <a class="hover:text-primary font-medium text-secondary-foreground text-xs"
                                                                            href="#">
                                                                            Landing-page.docx
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="flex items-center gap-1.5">
                                                                    <img class="h-6"
                                                                        src="@/theme/assets/media/file-types/svg.svg" />
                                                                    <div class="flex flex-col gap-0.5">
                                                                        <a class="hover:text-primary font-medium text-secondary-foreground text-xs"
                                                                            href="#">
                                                                            New-icon.svg
                                                    ...
                                                    <div class="flex grow gap-2.5 px-5">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar" src="@/theme/assets/media/avatars/300-21.png">
                                                                </img>
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                        ...
                                                        <div class="flex flex-col gap-3.5">
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <span class="text-secondary-foreground font-medium">
                                                                        This
                                                                        design is simply stunning! From layout to color,
                                                                        it's a work of art!
                                                                    </span>
                                                                </div>
                                                                <div class="kt-input">
                                                    ...
                                                    <div class="flex grow gap-2.5 px-5" id="notification_request_3">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar" src="@/theme/assets/media/avatars/300-13.png">
                                                                </img>
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                            ...
                                            <div class="grow kt-scrollable-y-auto" data-kt-scrollable="true"
                                                ...
                                                <div class="flex flex-col gap-5 pt-3 pb-4">
                                                    <div class="flex grow gap-2.5 px-5">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar" src="@/theme/assets/media/avatars/300-1.png">
                                                                </img>
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                    ...
                                                    <div class="flex grow gap-2.5 px-5" id="notification_request_17">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar"
                                                                    src="@/theme/assets/media/avatars/300-19.png" />
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                                    class="kt-avatar-status kt-avatar-status-online size-2.5">
                                                        ...
                                                        <div class="flex flex-col gap-2.5 grow">
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <img class="h-5"
                                                                        src="@/theme/assets/media/brand-logos/jira.svg" />
                                                                </div>
                                                                <a class="hover:text-primary font-medium text-secondary-foreground text-xs me-1"
                                                                    href="#">
                                                                    User-feedback.jira
                                                    ...
                                                    <div class="flex grow gap-2.5 px-5">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar"
                                                                    src="@/theme/assets/media/avatars/300-17.png" />
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                                    class="kt-avatar-status kt-avatar-status-online size-2.5">
                                                    ...
                                                    <div class="flex grow gap-2.5 px-5">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar"
                                                                    src="@/theme/assets/media/avatars/300-9.png" />
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                                    class="kt-avatar-status kt-avatar-status-online size-2.5">
                                                    ...
                                                    <div class="flex grow gap-2.5 px-5" id="notification_request_3">
                                                        <div class="kt-avatar size-8">
                                                            <div class="kt-avatar-image">
                                                                <img alt="avatar"
                                                                    src="@/theme/assets/media/avatars/300-13.png" />
                                                            </div>
                                                            <div class="kt-avatar-indicator -end-2 -bottom-2">
                                                                <div
                                                                    class="kt-avatar-status kt-avatar-status-online size-2.5">
                                            ...
                                            <div class="kt-card-content flex flex-col place-content-center gap-5">
                                                <div class="flex justify-center">
                                                    <img alt="image" class="dark:hidden max-h-[180px]"
                                                        src="@/theme/assets/media/illustrations/32.svg" />
                                                    <img alt="image" class="light:hidden max-h-[180px]"
                                                        src="@/theme/assets/media/illustrations/32-dark.svg" />
                                                </div>
                                                <div class="flex flex-col gap-4">
                                                    <div class="flex flex-col gap-3 text-center">
                                                        ...
                                                        <p class="text-sm font-medium text-secondary-foreground">
                                                            Enhance team formation and management with easy-to-use tools
                                                            for communication,
                                                            <br />
                                            ...
                                            <div class="kt-card-content flex flex-col gap-4 p-5 lg:p-7.5 lg:pt-4">
                                                ...
                                                <div class="grid gap-3">
                                                    ...
                                                    <div class="flex items-center justify-between flex-wrap gap-2">
                                                        <div class="flex items-center gap-1.5">
                                                            <i
                                                                class="ki-filled ki-google text-base text-muted-foreground">
                                                            </i>
                                                            <span class="text-sm font-normal text-mono">
                                                                Google
                                                            </span>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="flex -space-x-2">
                                                                                <div class="flex">
                                                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                                        src="@/theme/assets/media/avatars/300-24.png" />
                                                                                </div>
                                                                                <div class="flex">
                                                                                    <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                                                        src="@/theme/assets/media/avatars/300-7.png" />
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="flex items-center gap-2 order-2 md:order-1">
                                                                ...
                                                                <select class="kt-select w-16"
                                                                    data-kt-datatable-size="true" name="perpage">
                                                                </select>
                                                                per page
                                                            </div>
                                        ...
                                        <div class="kt-card h-full">
                                            ...
                                            <div class="kt-card-content flex flex-col gap-5">
                                                <div class="text-sm text-foreground">
                                                    Users on the block list are unable to send chat requests or messages
                                                    to you anymore, ever, or again
                                                </div>
                                                ...
                                                <div class="flex flex-col gap-5">
                                                        ...
                                                        <div class="flex items-center gap-2.5">
                                                            <div class="">
                                                                <img class="h-9 rounded-full"
                                                                    src="@/theme/assets/media/avatars/gray/1.png" />
                                                            </div>
                                                            <div class="flex flex-col gap-0.5">
                                                    ...
                                                    <div class="flex items-center justify-between gap-2.5">
                                                        <div class="flex items-center gap-2.5">
                                                            <div class="">
                                                                <img class="h-9 rounded-full"
                                                                    src="@/theme/assets/media/avatars/gray/2.png" />
                                                            </div>
                                                            <div class="flex flex-col gap-0.5">
                                                                <a class="flex items-center gap-1.5 leading-none font-medium text-sm text-mono hover:text-primary"
                                                                    href="html/demo8/public-profile/teams.html">
                                                    ...
                                                    <div class="flex items-center justify-between gap-2.5">
                                                        <div class="flex items-center gap-2.5">
                                                            <div class="">
                                                                <img class="h-9 rounded-full"
                                                                    src="@/theme/assets/media/avatars/gray/3.png" />
                                                            </div>
                                                            <div class="flex flex-col gap-0.5">
                                                                <a class="flex items-center gap-1.5 leading-none font-medium text-sm text-mono hover:text-primary"
                                                                    href="html/demo8/public-profile/teams.html">
                                            ...
                                            <div class="kt-card-content grid gap-5 lg:gap-7.5 lg:py-7.5 py-5">
                                                <div class="grid gap-5">
                                                        ...
                                                        <div class="flex items-center flex-wrap gap-3.5">
                                                            ...
                                                            <div class="flex flex-col">
                                                                <div class="flex items-center gap-1.5">
                                                                    ...
                                                                    <a class="text-sm font-medium text-muted-foreground hover:text-primary"
                                                                        href="#">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex items-center flex-wrap gap-3.5">
                                                            <img alt="" class="size-8 shrink-0"
                                                                src="@/theme/assets/media/brand-logos/evernote.svg" />
                                                            <div class="flex flex-col">
                                                                <div class="flex items-center gap-1.5">
                                                                    <a class="text-sm font-semibold text-mono hover:text-primary"
                                                                        href="#">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex items-center flex-wrap gap-3.5">
                                                            <img alt="" class="size-8 shrink-0"
                                                                src="@/theme/assets/media/brand-logos/inferno.svg" />
                                                            <div class="flex flex-col">
                                                                <div class="flex items-center gap-1.5">
                                                                    <a class="text-sm font-semibold text-mono hover:text-primary"
                                                                        href="#">
                                        ...
                                        <div class="kt-menu-link flex items-center jistify-between gap-2">
                                            ...
                                            <div class="flex justify-end shrink-0">
                                                <div class="flex -space-x-2">
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                            src="@/theme/assets/media/avatars/300-14.png" />
                                                    </div>
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                            src="@/theme/assets/media/avatars/300-12.png" />
                                                    </div>
                                                    <div class="flex">
                                                        <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                            src="@/theme/assets/media/avatars/300-9.png" />
                                ...
                                <div class="kt-menu-link flex items-center jistify-between gap-2">
                                    ...
                                    <div class="flex justify-end shrink-0">
                                        <div class="flex -space-x-2">
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="@/theme/assets/media/avatars/300-6.png" />
                                            </div>
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="@/theme/assets/media/avatars/300-3.png" />
                                            ...
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="@/theme/assets/media/avatars/300-8.png" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="kt-menu-link flex items-center jistify-between gap-2">
                                    <div class="flex items-center grow gap-2">
                                        <div
                                            class="flex items-center justify-center size-10 shrink-0 rounded-full border border-border bg-accent/60">
                                            <img alt="" class="size-6 shrink-0"
                                                src="@/theme/assets/media/brand-logos/gitlab.svg" />
                                        </div>
                                        <div class="flex flex-col gap-0.5">
                                            <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
                                                Gitlab
                                    ...
                                    <div class="flex justify-end shrink-0">
                                        <div class="flex -space-x-2">
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="@/theme/assets/media/avatars/300-18.png" />
                                            </div>
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="@/theme/assets/media/avatars/300-17.png" />
                                ...
                                <div class="kt-menu-link flex items-center jistify-between gap-2">
                                    ...
                                    <div class="flex justify-end shrink-0">
                                        <div class="flex -space-x-2">
                                            ...
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="@/theme/assets/media/avatars/300-20.png" />
                                            </div>
                                            <div class="flex">
                                                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                                    src="@/theme/assets/media/avatars/300-21.png" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="grid gap-1">
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex justify-between gap-2">
                                        <div class="flex items-center gap-2.5">
                                            <img alt="" class="rounded-full size-9 shrink-0"
                                                src="@/theme/assets/media/avatars/300-11.png" />
                                            <div class="flex flex-col">
                                                <a class="text-sm font-semibold text-mono hover:text-primary mb-px"
                                                    href="#">
                                                    Jacob Jones
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex justify-between gap-2">
                                        <div class="flex items-center gap-2.5">
                                            <img alt="" class="rounded-full size-9 shrink-0"
                                                src="@/theme/assets/media/avatars/300-5.png" />
                                            <div class="flex flex-col">
                                                <a class="text-sm font-semibold text-mono hover:text-primary mb-px"
                                                    href="#">
                                                    TLeslie Alexander
                        ...
                        <div class="kt-menu kt-menu-default px-0.5 flex-col">
                            <div class="grid">
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex items-center">
                                        <div class="flex items-center grow gap-2.5">
                                            <img src="@/theme/assets/media/file-types/pdf.svg" />
                                            <div class="flex flex-col">
                                                <span
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex items-center">
                                        <div class="flex items-center grow gap-2.5">
                                            <img src="@/theme/assets/media/file-types/doc.svg" />
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
                                                    Report-v1.docx
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex items-center">
                                        <div class="flex items-center grow gap-2.5">
                                            <img src="@/theme/assets/media/file-types/javascript.svg" />
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
                                                    Framework-App.js
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex items-center">
                                        <div class="flex items-center grow gap-2.5">
                                            <img src="@/theme/assets/media/file-types/ai.svg" />
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
                                                    Framework-App.js
                                ...
                                <div class="kt-menu-item">
                                    <div class="kt-menu-link flex items-center">
                                        <div class="flex items-center grow gap-2.5">
                                            <img src="@/theme/assets/media/file-types/php.svg" />
                                            <div class="flex flex-col">
                                                <span
                                                    class="text-sm font-semibold text-mono cursor-pointer hover:text-primary mb-px">
                                                    appController.js
                        ...
                        <div class="flex flex-col text-center py-9 gap-5">
                            <div class="flex justify-center">
                                <img alt="image" class="dark:hidden max-h-[113px]"
                                    src="@/theme/assets/media/illustrations/33.svg" />
                                <img alt="image" class="light:hidden max-h-[113px]"
                                    src="@/theme/assets/media/illustrations/33-dark.svg" />
                            </div>
                            <div class="flex flex-col gap-1.5">
            ...
            <div class="kt-modal-body grid gap-5 px-0 py-5">
                ...
                <div class="kt-scrollable-y-auto max-h-[300px]">
                    <div class="flex flex-col px-5 gap-3">
                        <div class="flex items-center flex-wrap gap-2">
                            <div class="flex items-center grow gap-2.5">
                                <img alt="" class="rounded-full size-9 shrink-0" src="@/theme/assets/media/avatars/300-3.png" />
                                <div class="flex flex-col">
                        ...
                        <div class="flex items-center flex-wrap gap-2">
                            <div class="flex items-center grow gap-2.5">
                                <img alt="" class="rounded-full size-9 shrink-0" src="@/theme/assets/media/avatars/300-1.png" />
                                <div class="flex flex-col">
                                    <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
                                        Esther Howard
                                    </a>
                ...
                <div class="p-5">
                    <div class="grid place-items-center gap-1">
                        <div class="flex justify-center items-center rounded-full">
                            <img class="rounded-full max-h-[55px] max-w-full" src="@/theme/assets/media/avatars/300-1.png" />
                        </div>
